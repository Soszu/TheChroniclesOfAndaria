...
/**
 * @brief OknoGracza::wyswietlGracz	WyÅwietla dane podanego gracza.
 * @param gracz
 */
...
/**
 * @brief OknoGracza::uaktualnijInformacje	OdÅwieÅ¼a dane i powiadamia o zmianie
 */
...
/**
 * @brief OknoGracza::odmiana Odmienia sÅowo "sztuka" zaleÅ¼nie od liczby sztuk zÅota
 * @param n ile sztuk
 * @return
 */
...
/**
 * @brief OknoGracza::pokazEkwipunek WywoÅuje Okno Ekwipunek
 */
...
/**
 * @brief OknoGracza::pokazZadania	WywoÅuje Okno Zadania
 */
